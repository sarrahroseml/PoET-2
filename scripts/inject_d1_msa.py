"""Inject MSA paths from D1 MSA search into D1 Protenix batch JSONs."""
...
def main():
    msa_dir = Path("data/d1_logan/msa_jobs/outputs")
    input_dir = Path("data/d1_logan/protenix_jobs/inputs")
